    ...
    <>
      ...
      >
        <div className="flex flex-wrap items-center justify-between gap-x-2 gap-y-1.5">
          ...
          {posted && <span className="text-xs font-medium text-zinc-400">{posted}</span>}
        </div>
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <h2 className="mt-3 pr-10 text-xl font-bold leading-snug text-white sm:text-2xl">{job.title}</h2>
