  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div
            className={`glass relative my-2 w-full max-w-xl rounded-2xl p-5 ring-1 sm:my-4 sm:rounded-3xl sm:p-7 ${accent.ring.replace("group-hover:", "")}`}
          ...
          >
            ...
            <h2 className="mt-3 pr-10 text-xl font-bold leading-snug text-white sm:text-2xl">{opp.title}</h2>
